	...
	>
		<el-row :gutter="40">
			...
			<el-col :span="12">
				...
				<el-row :gutter="20">
					<el-col :span="8">
						<el-form-item label="Brand" prop="note">
							<el-input v-model="form.brand" />
						</el-form-item>
					</el-col>
					<el-col :span="8">
						<el-form-item label="Model" prop="note">
							<el-input v-model="form.model" />
						</el-form-item>
					</el-col>
					<el-col :span="8">
						<el-form-item label="Year" prop="note">
				...
				<el-row :gutter="20">
					<el-col :span="8">
						<el-form-item label="Series" prop="note">
							<el-input v-model="form.series" />
						</el-form-item>
					</el-col>
					<el-col :span="8">
						<el-form-item label="Engine" prop="note">
				...
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="Body Style" prop="note">
							<el-input v-model="form.bodyStyle" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="Vin Number" prop="note">
